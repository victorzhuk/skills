...
- **[z-react-core](./z-react-core/SKILL.md)** — React and Next.js conventions beyond TypeScript tooling — App Router, server components by default, server data fetching, URL/server state before client stores, server actions, suspense/error boundaries.
