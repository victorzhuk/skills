...
- **[z-ru-tech-register](./skills/writing/z-ru-tech-register/SKILL.md)** — Russian tech prose in the native senior-engineer register — Latin-vs-Cyrillic term choice, serious-register structure, RU neuro-slop tells, and the bilingual RU/EN terminology glossary by theme cluster. Telegram post format lives in [[z-tg-post]].
- **[z-tg-post](./skills/writing/z-tg-post/SKILL.md)** — Write, rewrite, or review short-form posts for the author's Telegram tech blog in his voice — Telegram user-Markdown formatting (HTML for bot/API), post structure, the compressed anti-slop voice. Register and glossary live in [[z-ru-tech-register]].
